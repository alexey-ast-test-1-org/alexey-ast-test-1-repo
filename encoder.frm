...
Dim param2 As ADODB.Parameter
    ...
    Set param1 = cmd.CreateParameter("UserName", adVarChar, adParamInput, 255, user_name)
    cmd.Parameters.Append param1
    Set param2 = cmd.CreateParameter("Password", adVarChar, adParamInput, 255, password)
